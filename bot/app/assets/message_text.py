...
delete_button_vector = "🗑 - Удалить файл"
libray_button_vector = "📔 - Посмотреть личную библиотеку"
...
library_message = "<b>Личная библиотека 📔</b>\n\n"
...
{bio}
'''
success_delete_message = '<b>Ваш файл {} удален"</b>\n\n' + main_menu_vector + "\n" + methods_menu_vector + "\n" + libray_button_vector